...
function Expenses() {
  ...
  const inputClasses =
    'w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-800'

  return (
    <div className="max-w-2xl mx-auto mt-10 space-y-8">
      <div className="bg-white rounded-2xl shadow-md p-8">
        <h1 className="text-xl font-bold text-gray-800 mb-4">Add Expense</h1>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="col-span-1 sm:col-span-2">
            <button
              type="submit"
              disabled={adding}
              className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 rounded-lg transition mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="bg-white rounded-2xl shadow-md p-8">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Your Expenses</h2>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 text-sm font-medium transition ml-4"
                  >
                    Delete
                  </button>
                </div>
