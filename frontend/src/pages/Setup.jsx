  ...
  if (loading) {
    return (
      <div className="bg-gray-950 min-h-screen -m-6 p-6">
        <div className="max-w-lg mx-auto pt-8 text-gray-400">Loading...</div>
      </div>
    )
  }

  const inputClasses =
    'w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500'

  return (
    <div className="bg-gray-950 min-h-screen -m-6 p-6">
      <div className="max-w-lg mx-auto pt-8 animate-fade-in-up">
        <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
          <h1 className="text-2xl font-bold text-white mb-6">Setup Budget</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full bg-teal-500 hover:bg-teal-600 text-white font-semibold py-2 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
